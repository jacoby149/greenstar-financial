...
\noindent Birthday : {\VAR{birthday}} \\
%\noindent Purpose : Retirement \\
\noindent Time Frame : {\VAR{term}} \\
\noindent Available Funds : \$1,232,683.45 \\
\noindent Preferred Risk : ($\pm {\VAR{risk_new}}\%$ Yearly) \\
\noindent \textbf{Preferred Asset Classes:} \\

    \BLOCK{ for key, value in preferred.iterrows() }
        -- \VAR{key} \\
    \BLOCK{ endfor }
...
\begin{tabular}{cccc}
    ...
    \BLOCK{ for key, value in newcap.iterrows() }
        \VAR{key} & \$\VAR{value.1} & \$\VAR{value.2} & \$\VAR{value.2} \\ \midrule
    \BLOCK{ endfor }
...
\hspace*{-1cm}\includegraphics[width=.95\linewidth]{/app/plts/bellcompare.png}\par

\vspace{.5cm}

\hspace*{-1cm}\includegraphics[width=.8\linewidth]{/app/plts/line7.png}\par
\end{center}
...
\begin{center}
  ...
  \includegraphics[width=.35\linewidth]{/app/plts/bell.png}
    & \hspace{1cm }&\includegraphics[width=.35\linewidth]{/app/plts/line1.png}
  \end{tabular}
  \end{center}
...
\begin{center}
  \begin{tabular}{lcr}
  \includegraphics[width=.35\linewidth]{/app/plts/bellcompare.png}
...
\hspace*{-2.5cm}\includegraphics[width=1.2\linewidth]{/app/plts/frontier.png}\par
