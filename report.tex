...
\begin{center}
  ...
  \begin{tabular}{ccc}
  \hspace*{-1.5cm}\includegraphics[width=.55\linewidth]{/app/plts/pie.png}
    & \hspace{0.5cm}&\includegraphics[width=.55\linewidth]{/app/plts/piefuture.png} \\
...
\begin{center}
  ...
  \includegraphics[width=.45\linewidth]{/app/plts/bell.png}
    & \hspace{1cm }&\includegraphics[width=.45\linewidth]{/app/plts/line1.png}
  \end{tabular}
  \end{center}
...
\begin{center}
  ...
  \includegraphics[width=.45\linewidth]{/app/plts/bellcompare.png}
    & \hspace{1cm }&\includegraphics[width=.45\linewidth]{/app/plts/line7.png}
  \end{tabular}
  \end{center}
