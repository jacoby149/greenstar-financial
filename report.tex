...
Change In Expected Return : {\VAR{ret_change}}\\
Change in Risk : {\VAR{risk_change}}
...
1 Year Risk (Std Deviation \%) : $\pm$ {\VAR{info.blueonerisk}}
\\ \\
\noindent
...
1 Year Risk (Std Deviation \%): $\pm$ {\VAR{info.redonerisk}}
\\ \\
\noindent
...
Change in Return (\%): {\VAR{ret_change}}
