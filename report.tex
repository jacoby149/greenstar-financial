...
\begin{tabular}[t]{c}
(a) Current Portfolio\\
\includegraphics[width=.45\linewidth]{/app/img/pie.png}\\
(b) New Portfolio\\
\includegraphics[width=.45\linewidth]{/app/img/pie.png}
\end{tabular}
\end{tabular}
...
\vspace{.4cm}
\begin{center}
\hspace*{-1cm}\includegraphics[width=.95\linewidth]{/app/img/bell.png}\par

\vspace{.5cm}

\hspace*{-1cm}\includegraphics[width=.8\linewidth]{/app/img/expected_return.png}\par
\end{center}
...
\begin{center}
  \begin{tabular}{c}
    \includegraphics[width=.5\linewidth]{/app/img/pie.png}
  \end{tabular}
  \end{center}
...
\begin{center}
  \begin{tabular}{lcr}
  \includegraphics[width=.35\linewidth]{/app/img/bell.png}
    & \hspace{1cm }&\includegraphics[width=.35\linewidth]{/app/img/expected_return.png}
  \end{tabular}
  \end{center}
...
\hspace*{-1cm}\includegraphics{/app/img/curve.png}\par
...
\vspace{.4cm}
\begin{center}
\hspace*{-1cm}\includegraphics[width=.95\linewidth]{/app/img/stocks.png}\par

\vspace{.2cm}

\hspace*{-1cm}\includegraphics[width=.95\linewidth]{/app/img/back.png}\par
\end{center}
