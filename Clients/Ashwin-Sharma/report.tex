...
\begin{center}
	...
	\includegraphics[width=.8\linewidth]{/app/static/img/Moore.png}\par
    \vspace{-.2cm}
...
\end{center}
	...
	\begin{center}
	 	{
		\small{
		Prepared by Ashwin Sharma

		ASHWIN@MOOREFINANCIALSERVICES.COM}
		\par}
...
\begin{center}
  ...
  \begin{tabular}{ccc}
  \hspace*{-1.5cm}\includegraphics[width=.55\linewidth]{/app/plts/pie.pdf}
    & \hspace{0.5cm}&\includegraphics[width=.55\linewidth]{/app/plts/piefuture.pdf} \\
...
\includegraphics[width=.8\linewidth]{/app/plts/bellcompare.pdf}\par

\vspace{.5cm}

\hspace*{-1cm}\includegraphics[width=.8\linewidth]{/app/plts/line7.pdf}\par
\end{center}
...
\begin{center}
  \begin{tabular}{c}
    \includegraphics[width=.5\linewidth]{/app/plts/pie.pdf}
%
%\begin{figure}[htbp]
%  \centering
%  \includesvg{pie}
...
\begin{center}
  \begin{tabular}{lcr}
  \includegraphics[width=.45\linewidth]{/app/plts/bell.pdf}
    & \hspace{1cm }&\includegraphics[width=.45\linewidth]{/app/plts/line1.pdf}
  \end{tabular}
  \end{center}
...
\begin{center}
  \begin{tabular}{lcr}
  \includegraphics[width=.45\linewidth]{/app/plts/bellcompare.pdf}
    & \hspace{1cm }&\includegraphics[width=.45\linewidth]{/app/plts/line7.pdf}
  \end{tabular}
  \end{center}
...
\begin{center}
  \begin{tabular}{c}
    \includegraphics[width=.5\linewidth]{/app/plts/piefuture.pdf}
  \end{tabular}
  \end{center}
...
\begin{center}
  \begin{tabular}{lcr}
  \includegraphics[width=.45\linewidth]{/app/plts/bellfuture.pdf}
    & \hspace{1cm }&\includegraphics[width=.45\linewidth]{/app/plts/line1.pdf}
  \end{tabular}
  \end{center}
...
\hspace*{-2.5cm}\includegraphics[width=1.2\linewidth]{/app/plts/frontier.pdf}\par
